...
public class ONScripter extends Activity implements AdapterView.OnItemClickListener, Runnable
{
    ...
    public boolean onPrepareOptionsMenu(Menu menu)
    {
        if (mGLView != null){
            ...
            if (mButtonVisible) {
                sm.setGroupVisible(1,true);
                sm.setGroupVisible(2,false);
            }else{
                sm.setGroupVisible(1,false);
                sm.setGroupVisible(2,true);
            }
        }else{
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        if (item.getItemId() == Menu.FIRST){
            ...
            mButtonVisible = mButtonVisible ? false : true;
            resetLayout();
